(function($,d){
	var ui = {
		site : "http://127.0.0.1:8087/vvtour/front/static/",
		...
		get :{
			tab : function(opt){
				var _this = this;
				ui.js(!ui.extend.tab,ui.site+"js/plugin/jquery.tab.js",function(){
					ui.extend.tab.call(_this,opt);
				});
			},
			lazyload : function(opt){
				var _this = this;
				ui.js(!ui.extend.lazyload,ui.site+"js/plugin/jquery.lazyload.js",function(){
			...
			popDiv : function(opt){
				var thisObj = $(this);
				var selector = opt.to;
				ui.js(!thisObj.openDialog,ui.site+"js/plugin/jquery.dialog.js",function(){
					if(selector){
						delete opt.to;
			...
			countdown : function(opt){
				var _this = this;
				ui.js(!ui.extend.countdown,ui.site+"js/plugin/jquery.countdown.js",function(){
			...
			autoCompleteV2 : function(opt){
				...
				var _this = this;
				ui.js(!ui.extend.autoComplete,ui.site+"js/plugin/jquery.autocompleteV2.js",function(){
			...
			autoComplete : function(opt){
				var txt = $(this);
				//UI.css(true,"http://pic.lvmama.com/styles/new_v/ui_plugins/ui-components.css");
				ui.js(!txt.hotelAutocomplete,ui.site+"js/plugin/jquery.autocomplete.js",function(){
					txt.hotelAutocomplete(opt);
				});
			},
			adAutoComplete : function(opt){
				...
				ui.js(!ui.extend.adAutoComplete,ui.site+"js/plugin/jquery.adAutocomplete.js",function(){
					ui.extend.adAutoComplete.call(_this,opt);
				});
			},
			slideMenu : function(opt){
				var _this = this;
				ui.js(!ui.extend.slideMenu,ui.site+"js/plugin/jquery.slideMenu.js",function(){
					ui.extend.slideMenu.call(_this,opt);
				});
			},
			roller : function(opt){
				var _this = this;
				ui.js(!ui.extend.roller,ui.site+"js/plugin/jquery.roller.js",function(){
					ui.extend.roller.call(_this,opt);
				});
			},
			scrollImg : function(opt){
				var _this = this;
				ui.js(!ui.extend.scrollImg,ui.site+"js/plugin/jquery.scrollImg.js",function(){
					ui.extend.scrollImg.call(_this,opt);
				});
			},
			selectArea : function(opt){
				var _this = this;
				ui.js(!ui.extend.city,ui.site+"js/plugin/jquery.city.js",function(){
			...
			lvtip : function(opt){
				...
				var _this = this;
				ui.js(!ui.extend.lvtip,ui.site+"js/plugin/jquery.lvtip.js",function(){
					ui.extend.lvtip.call(_this,opt);
				});
			},
			page : function(opt){
				var _this = this;
				ui.js(!ui.extend.page,ui.site+"js/plugin/jquery.page.js",function(){
					ui.extend.page.call(_this,opt);
				});
			},
			validate : function(opt){
				var _this = this;
				ui.js(!ui.extend.validate,ui.site+"js/plugin/jquery.validate.js",function(){
					ui.extend.validate.call(_this,opt);
				});
			},
			preview : function(opt){
				var _this = this;
				ui.js(!ui.extend.preview,ui.site+"js/plugin/jquery.preview.js",function(){
					ui.extend.preview.call(_this,opt);
				});
			},
			calendar : function(opt){
				ui.js(!window.WdatePicker,ui.site+"js/plugin/My97Date/WdatePicker.js",function(){
					if(opt){
			...
			floatDiv : function(opt){
				var _this = this;
				ui.js(!ui.extend.floatDiv,ui.site+"js/plugin/jquery.floatDiv.js",function(){
					ui.extend.floatDiv.call(_this,opt);
				});
			},
			recommend : function(opt){
				var _this = this;
				ui.js(!ui.extend.recommend,ui.site+"js/plugin/jquery.recommend.js",function(){
			...
			focusImg : function(opt){
				var _this = this;
				ui.js(!ui.extend.focusImg,ui.site+"js/plugin/jquery.focusImg.js",function(){
