...
<script language="javascript">
	$(function(){
       ...
       <div class="cptt mt25 clearfix">
          <h3>产品特推</h3>
           ${channel_freedom_tuangou}
       </div>
       
       <div class="lyxl mt25 clearfix">
          <h3>国内旅游路线</h3>
          <ul>
             <li id="one1" onclick="setTab('one',1,10)"  class="active">日本</li>
             <li id="one2" onclick="setTab('one',2,10)" >国内</li>
             <li id="one3" onclick="setTab('one',3,10)" >韩国</li>
             <li id="one4" onclick="setTab('one',4,10)" >泰国</li>
             <li id="one5" onclick="setTab('one',5,10)" >欧洲</li>
             <li id="one6" onclick="setTab('one',6,10)" >周边</li>
          </ul>
          
          <!-- 产品路线内容1 -->
          ${channel_freedom_con1}
          <!-- 产品路线内容1 -->

          <!-- 产品路线内容2 -->
          ${channel_freedom_con2}
          <!-- 产品路线内容2 -->
          
          <!-- 产品路线内容3 -->
          ${channel_freedom_con3}
          <!-- 产品路线内容3 -->
          
          <!-- 产品路线内容4 -->
          ${channel_freedom_con4}
          <!-- 产品路线内容4 -->
          
          <!-- 产品路线内容5 -->
          ${channel_freedom_con5}
          <!-- 产品路线内容5 -->
          
          <!-- 产品路线内容6 -->
          ${channel_freedom_con6}
          <!-- 产品路线内容6 -->
