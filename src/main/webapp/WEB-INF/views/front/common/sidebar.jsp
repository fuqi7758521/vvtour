...
<div class="left">
			...
			<div class="leftB">
				...
				<ul>
					<li><span><img src="<%=request.getContextPath() %>/front/static/img/grzx_40.jpg" /></span><a href="<%=request.getContextPath() %>/user/goUserDetail.htm">个人资料</a><a href="<%=request.getContextPath() %>/user/goUserDetail.htm" style=" float:right; color:#0088cc;">完善</a></li>
