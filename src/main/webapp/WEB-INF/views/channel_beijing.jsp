...
<script language="javascript">
	$(function(){
       ...
       <div class="cptt mt25 clearfix">
          <h3>产品特推</h3>
           ${channel_beijing_tuangou}
       </div>
       
       <div class="lyxl mt25 clearfix">
          <h3>国内旅游路线</h3>
          <ul>
             <li id="one1" onclick="setTab('one',1,10)"  class="active">北京</li>
             <li id="one2" onclick="setTab('one',2,10)" >河北</li>
             <li id="one3" onclick="setTab('one',3,10)" >山东</li>
             <li id="one4" onclick="setTab('one',4,10)" >山西</li>
             <li id="one5" onclick="setTab('one',5,10)" >长白山</li>
             <li id="one6" onclick="setTab('one',6,10)" >内蒙古</li>
             <li id="one7" onclick="setTab('one',7,10)" >辽宁</li>
             <li id="one8" onclick="setTab('one',8,10)" >哈尔滨</li>
          </ul>
          
          <!-- 产品路线内容1 -->
          ${channel_beijing_con1}
          <!-- 产品路线内容1 -->

          <!-- 产品路线内容2 --> 
          ${channel_beijing_con2}
          <!-- 产品路线内容2 -->
          
          <!-- 产品路线内容3 -->
          ${channel_beijing_con3}
          <!-- 产品路线内容3 -->
          
          <!-- 产品路线内容4 -->
          ${channel_beijing_con4}
          <!-- 产品路线内容4 -->
          
          <!-- 产品路线内容5 -->
          ${channel_beijing_con5}
          <!-- 产品路线内容5 -->
