...
<script language="javascript">
	$(function(){
       ...
       <div class="cptt mt25 clearfix">
          <h3>产品特推</h3>
           ${channel_island_tuangou}
       </div>
       
       <div class="lyxl mt25 clearfix">
          <h3>国内旅游路线</h3>
          <ul>
             <li id="one1" onclick="setTab('one',1,10)"  class="active">马尔代夫</li>
             <li id="one2" onclick="setTab('one',2,10)" >巴厘岛</li>
             <li id="one3" onclick="setTab('one',3,10)" >普吉岛</li>
             <li id="one4" onclick="setTab('one',4,10)" >塞班岛</li>
             <li id="one5" onclick="setTab('one',5,10)" >关岛</li>
             <li id="one6" onclick="setTab('one',6,10)" >夏威夷</li>
             <li id="one7" onclick="setTab('one',7,10)" >大溪地</li>
          </ul>
