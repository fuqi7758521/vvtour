...
<script language="javascript">
	$(function(){
       ...
       <div class="cptt mt25 clearfix">
          <h3>产品特推</h3>
           ${channel_abroad_tuangou}
       </div>
       
       <div class="lyxl mt25 clearfix">
          <h3>国外旅游路线</h3>
          <ul>
             <li id="one1" onclick="setTab('one',1,10)"  class="active">东南亚</li>
             <li id="one2" onclick="setTab('one',2,10)" >日韩</li>
             <li id="one3" onclick="setTab('one',3,10)" >欧洲</li>
             <li id="one4" onclick="setTab('one',4,10)" >海岛</li>
             <li id="one5" onclick="setTab('one',5,10)" >港澳</li>
             <li id="one6" onclick="setTab('one',6,10)" >美国</li>
             <li id="one7" onclick="setTab('one',7,10)" >南亚</li>
             <li id="one8" onclick="setTab('one',8,10)" >俄罗斯</li>
             <li id="one9" onclick="setTab('one',9,10)" >中东非</li>
             <li id="one10" onclick="setTab('one',10,10)" >邮轮</li>
          </ul>
