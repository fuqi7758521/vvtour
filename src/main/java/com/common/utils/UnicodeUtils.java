...
public class UnicodeUtils {
	 ...
	 * @param escapeSpace是否忽略空格，为true时在空格后面是否加个反斜杠。
...
//        System.out.println("Original:\t\t" + s);
        ...
        s = toEncodedUnicode("国内游", true);
        
        System.out.println("国内游: " + s);
        
        s = toEncodedUnicode("出境游", true);
        
        System.out.println("出境游： " + s);
        
        s = toEncodedUnicode("海岛游", true);
        
        System.out.println("海岛游： " + s);
        
        s = toEncodedUnicode("公司旅游", true);
        
        System.out.println("公司旅游： " + s);
        
        s = toEncodedUnicode("邮轮", true);
        
        System.out.println("邮轮： " + s);
        
        s = toEncodedUnicode("签证", true);
        
        System.out.println("签证： " + s);
